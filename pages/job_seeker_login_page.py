...
def job_seeker_login():
    ...
    st.markdown('<div class="subheader">🧑‍💼 Login As Job Seeker</div>', unsafe_allow_html=True)
    ...
    with col1:
        if st.button("Log in", type="primary"):
            try:
                ...
                if email in credentials and credentials[email]['password'] == password and credentials[email]['role'] == 1:
                    st.session_state.job_seeker_logged_in = True
